...
def Model(source):
    ...
    #     if statement.type in header_types:
    #         current_section = Section(statement)
    #         sections.append(current_section)
    #     else:
    #         if not sections:
    #             sections.append(Section(None))
    #
    #         if current_statement.tokens:
    #             if current_statement.type != Token.NAME and \
    #                     current_section.statements and \
    #                     current_section.statements[-1].type in [Token.NAME, Token.FOR]:
    #                 current_section.statements[-1].statements.append(
    #                     current_statement)
    #             elif not in_header:
    #                 current_section.statements.append(current_statement)
    #         in_header = False
    ...
    #             token.value = 'END'
    #         if token.type == token.OLD_FOR_INDENT:
    #             continue
    #         if current_statement is None:
    #             current_statement = Statement(token)
    #         else:
    #             current_statement.tokens.append(token)
    # return sections
